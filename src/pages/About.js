      ...
      <div className="container">
        <div className="row">
          ...
          <div className="flex">
            ...
            <p>Welcome to My Vegetable Shop, your one-stop destination for fresh and organic vegetables sourced directly from local farmers. We are passionate about providing you and your family with the best quality produce, all delivered right to your doorstep</p>
            ...
            <section>
              <h2>Why Choose Us</h2>
              <ul>
                <li>Freshness Guaranteed: We take pride in offering only the freshest vegetables. Our produce comes straight from the farm to your table, ensuring maximum nutrition and taste.</li>
            ...
            <section>
              ...
              <p>At My Vegetable Shop, we are committed to your satisfaction. We value your feedback and continuously strive to improve our services. If you have any questions, suggestions, or concerns, please feel free to contact us at contact@myvegetableshop.com or call us at (123) 456-7890.</p>
            </section>
